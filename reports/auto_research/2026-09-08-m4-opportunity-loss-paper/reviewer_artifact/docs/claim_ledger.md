...
| C14 | The effect generalizes to other model families, RL algorithms, hardware, or deployment environments. | External-validity claim | Unsupported and prohibited | Tested scope is Qwen3-0.6B/1.7B, GRPO, two H100s in one accelerator environment, and three math workloads |
