#!/usr/bin/env python3
"""Build the authorized credential-free OARS shadow preflight manifest."""
...
def main() -> None:
    ...
    if (
        ...
        != "m4-oars-fifo-controlled-shadow-preflight-authorization-v1"
...
readonly RUN_REPO=/workspace/m4-oars-shadow-preflight-repo
readonly SOURCE=/workspace/m4-oars-shadow-preflight-source.tar.gz
readonly MEGATRON=/workspace/m4-oars-shadow-preflight-megatron.tar.gz
readonly PROTOCOL=/workspace/m4-oars-shadow-preflight-protocol.json
readonly AUTH=/workspace/m4-oars-shadow-preflight-authorization.json
readonly ASSETS={{assets_dir}}
readonly RUN_LOG=$ASSETS/m4-oars-shadow-preflight-run.log
readonly LIFECYCLE=$ASSETS/m4-oars-shadow-preflight-lifecycle.jsonl
readonly OPPORTUNITY=$ASSETS/m4-oars-shadow-preflight-opportunity.jsonl
readonly DUTY=$ASSETS/m4-oars-shadow-preflight-gradient-observer-duty.json
readonly OARS=$ASSETS/m4-oars-shadow-preflight-oars.jsonl
readonly RESULT=$ASSETS/m4-oars-shadow-preflight-result.json
readonly HASHES=$ASSETS/m4-oars-shadow-preflight-artifacts.sha256
readonly METRICS=$ASSETS/m4-oars-shadow-preflight-metrics
...
'''
    ...
    manifest = {
        ...
        "spec": {
            "name": "m4-oars-fifo-controlled-shadow-preflight",
            "workspace": "/workspace",
            "nodes": 1,
            "time_limit": 14400,
