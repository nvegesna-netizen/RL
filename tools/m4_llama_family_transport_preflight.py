...
PINNED_FILES = (
    ...
    *QUALIFICATION_CONFIG_PATHS.values(),
    ...
    "tools/m4_llama_observer_benchmark.py",
    ...
    "tests/unit/tools/test_m4_llama_observer_benchmark.py",
    ...
    f"{REPORT_ROOT}/qualification_repair_r2.md",
    f"{REPORT_ROOT}/qualification_repair_r2_amendment.json",
)
